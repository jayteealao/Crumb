...
class BookmarksViewModelTest {
    ...
    @Test
    fun initialIsRefreshing_isFalse() =
        runTest(dispatcher) {
            advanceUntilIdle()
    ...
    @Test
    fun initialTagsForTweet_isEmpty() =
        runTest(dispatcher) {
            advanceUntilIdle()
    ...
    @Test
    fun initialAllTags_isEmptyUntilLoaded() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchMediaIfMissing_firstCall_invokesRepositoryOnce() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchMediaIfMissing_sameIdTwice_invokesRepositoryOnlyOnce() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchMediaIfMissing_repositoryThrows_isSwallowedAndAttemptStillRecorded() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchMediaIfMissing_distinctIds_eachInvokedOnce() =
        runTest(dispatcher) {
            vm.refetchMediaIfMissing("t1")
    ...
    @Test
    fun refetchLinksIfMissing_firstCall_invokesRepositoryOnce() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchLinksIfMissing_sameIdTwice_invokesRepositoryOnlyOnce() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchLinksIfMissing_repositoryThrows_isSwallowedAndAttemptStillRecorded() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchLinksIfMissing_distinctIds_eachInvokedOnce() =
        runTest(dispatcher) {
            vm.refetchLinksIfMissing("t1")
    ...
    @Test
    fun refetchQuotesIfMissing_firstCall_invokesRepositoryOnce() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchQuotesIfMissing_sameIdTwice_invokesRepositoryOnlyOnce() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchQuotesIfMissing_repositoryThrows_isSwallowedAndAttemptStillRecorded() =
        runTest(dispatcher) {
    ...
    @Test
    fun refetchQuotesIfMissing_distinctIds_eachInvokedOnce() =
        runTest(dispatcher) {
            vm.refetchQuotesIfMissing("t1")
    ...
    @Test
    fun init_callsSyncStatusRefresh() =
        runTest(dispatcher) {
            advanceUntilIdle()
    ...
    @Test
    fun isRefreshing_reflectsRepositoryState() =
        runTest(dispatcher) {
            advanceUntilIdle()
            assertFalse(vm.isRefreshing.value)
    ...
    @Test
    fun syncStatus_reflectsRepositoryFlow() =
        runTest(dispatcher) {
            advanceUntilIdle()
            assertNull(vm.syncStatus.value)
    ...
    @Test
    fun onTypeChipToggled_updatesFilterType() =
        runTest(dispatcher) {
            advanceUntilIdle()
    ...
    @Test
    fun onTypeChipToggled_unknownId_defaultsToAll() =
        runTest(dispatcher) {
            vm.onTypeChipToggled("VIDEO")
            assertEquals(TypeFilter.VIDEO, vm.filter.value.type)
    ...
    @Test
    fun onTagToggled_addsTagWhenAbsent() =
        runTest(dispatcher) {
            vm.onTagToggled("kotlin")
            assertTrue(
                vm.filter.value.selectedTags
                    .contains("kotlin"),
            )
        }

    @Test
    fun onTagToggled_removesTagWhenPresent() =
        runTest(dispatcher) {
            vm.onTagToggled("kotlin")
            vm.onTagToggled("kotlin")
            assertFalse(
    ...
    @Test
    fun onTagToggled_multipleTagsAccumulate() =
        runTest(dispatcher) {
            vm.onTagToggled("kotlin")
    ...
    @Test
    fun onTagsApplied_replacesExistingTags() =
        runTest(dispatcher) {
            vm.onTagToggled("old")
    ...
    @Test
    fun onTagsApplied_emptySetClearsTags() =
        runTest(dispatcher) {
            vm.onTagToggled("kotlin")
    ...
    @Test
    fun clearTagFilter_clearsSelectedTags() =
        runTest(dispatcher) {
            vm.onTagToggled("kotlin")
            vm.onTagToggled("android")
            vm.onTypeChipToggled("VIDEO")
    ...
    @Test
    fun softDelete_callsRepositorySoftDelete() =
        runTest(dispatcher) {
    ...
    @Test
    fun undoDelete_callsRepositoryUndoDelete() =
        runTest(dispatcher) {
    ...
    @Test
    fun confirmDeletePending_callsRepository() =
        runTest(dispatcher) {
    ...
    @Test
    fun cancelDeletePending_callsRepository() =
        runTest(dispatcher) {
    ...
    @Test
    fun loadTagsForTweet_populatesTagsForTweetMap() =
        runTest(dispatcher) {
    ...
    @Test
    fun loadTagsForTweet_mergesToExistingMap() =
        runTest(dispatcher) {
    ...
    @Test
    fun loadTagsForItems_populatesTagsForMultipleIds() =
        runTest(dispatcher) {
            val batch =
                mapOf(
                    "t1" to listOf("kotlin"),
    ...
    @Test
    fun loadTagsForItems_emptyListDoesNothing() =
        runTest(dispatcher) {
    ...
    @Test
    fun loadAllTags_populatesAllTagsFlow() =
        runTest(dispatcher) {
    ...
    @Test
    fun saveTags_callsRepositoryAndReloads() =
        runTest(dispatcher) {
    ...
    @Test
    fun refresh_callsRefreshBookmarksAndSyncStatus() =
        runTest(dispatcher) {
            vm.refresh()
            advanceUntilIdle()
    ...
    @Test
    fun refreshSyncStatus_callsSyncStatusRepositoryRefresh() =
        runTest(dispatcher) {
    ...
    @Test
    fun disconnectX_success_emitsSuccessEvent() =
        runTest(dispatcher) {
    ...
    @Test
    fun disconnectX_failure_emitsFailureEvent() =
        runTest(dispatcher) {
    ...
    @Test
    fun filterState_reflectsSequenceOfMutations() =
        runTest(dispatcher) {
            // Start from default
    ...
    @Test
    fun pagingFlow_callsRepositoryWhenCollected() =
        runTest(dispatcher) {
    ...
    @Test
    fun playVideo_buildsSingleSharedPlayer_andSetsActiveId() =
        runTest(dispatcher) {
    ...
    @Test
    fun playVideo_noPlayableSource_isNoOp() =
        runTest(dispatcher) {
    ...
    @Test
    fun clearActiveVideo_resetsActiveId() =
        runTest(dispatcher) {
            vm.playVideo(videoBookmark("v1"))
            advanceUntilIdle()
            assertEquals("v1", vm.activeVideoId.value)
    ...
    @Test
    fun expandThenCloseVideoViewer_togglesViewerState() =
        runTest(dispatcher) {
    ...
    @Test
    fun onAppPaused_pausesActivePlayback() =
        runTest(dispatcher) {
            vm.playVideo(videoBookmark("v1"))
            advanceUntilIdle()
            val p = vm.player!!
    ...
    @Test
    fun onAppResumed_whenNothingWasPlaying_doesNotForceResume() =
        runTest(dispatcher) {
    ...
    @Test
    fun lifecycleCallbacks_withNoActivePlayer_areNoOps() =
        runTest(dispatcher) {
    ...
    @Test
    fun onAppResumed_whenWasPlayingBeforePause_resumesPlayback() =
        runTest(dispatcher) {
            vm.playVideo(videoBookmark("v1"))
            advanceUntilIdle()
            val p = vm.player!!
    ...
    @Test
    fun pagingFlow_requeriesRepositoryWithTypeFilter_onTypeChipToggle() =
        runTest(dispatcher) {
            val job =
                CoroutineScope(dispatcher).launch {
                    vm.pagingFlow.collect {}
    ...
    @Test
    fun pagingFlow_requeriesRepositoryWithTagFilter_onTagsApplied() =
        runTest(dispatcher) {
            val job =
                CoroutineScope(dispatcher).launch {
                    vm.pagingFlow.collect {}
    ...
    @Test
    fun pagingFlow_requeriesRepositoryWithCombinedFilter_onTypeAndTagChange() =
        runTest(dispatcher) {
            val job =
                CoroutineScope(dispatcher).launch {
                    vm.pagingFlow.collect {}
    ...
    @Test
    fun loadTagsForItems_deltaOnly_queriesOnlyNewIds() =
        runTest(dispatcher) {
            coEvery { repository.getTagsForItems(listOf("t1", "t2")) } returns
                mapOf(
                    "t1" to listOf("kotlin"),
                    "t2" to emptyList(),
                )
    ...
    @Test
    fun loadTagsForItems_alreadyLoadedIds_skipRepositoryEntirely() =
        runTest(dispatcher) {
    ...
    @Test
    fun loadTagsForItems_overwrite_clearsStaleChips() =
        runTest(dispatcher) {
            coEvery { repository.getTagsForItems(listOf("t1")) } returns mapOf("t1" to listOf("kotlin"))
            vm.loadTagsForItems(listOf("t1"))
            advanceUntilIdle()
    ...
    @Test
    fun saveTags_invalidatesId_causingReloadOnNextBatch() =
        runTest(dispatcher) {
            coEvery { repository.getTagsForItems(listOf("t1")) } returns mapOf("t1" to listOf("kotlin"))
            coEvery { repository.getTagsForTweet("t1") } returns listOf("kotlin")
            coEvery { repository.getAllTags() } returns listOf("kotlin")
