...
class SwipeHandlerTest {
    ...
    private val noOpSyncEnqueuer =
        object : TwitterSyncEnqueuer {
    ...
    private fun newRepository(): Repository =
        Repository(
            tweetDao = tweetDao,
            authPref = prefs,
    ...
    @Test
    fun confirmDeletePending_writesTombstoneAndFirestoreMark() =
        runTest {
    ...
    @Test
    fun cancelDeletePending_writesRoomBeforeFirestore() =
        runTest {
    ...
    @Test
    fun confirmDeletePending_swallowsFirestoreError() =
        runTest {
    ...
    @Test
    fun cancelDeletePending_swallowsFirestoreError() =
        runTest {
