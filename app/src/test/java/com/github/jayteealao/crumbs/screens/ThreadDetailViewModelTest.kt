...
class ThreadDetailViewModelTest {
    ...
    private fun userEntity(id: String = "user1") =
        TwitterUserEntity(
            id = id,
            name = "Test User",
            username = "testuser",
    ...
    private fun ThreadDetailViewModel.activateUiState() = uiState.onEach {}.launchIn(kotlinx.coroutines.CoroutineScope(dispatcher))
    ...
    @Test
    fun nullBookmarkId_emitsErrorState() =
        runTest(dispatcher) {
    ...
    @Test
    fun bookmarkIdNotInDao_emitsErrorState() =
        runTest(dispatcher) {
    ...
    @Test
    fun blankConversationId_emitsLoadedWithEmptyReplies() =
        runTest(dispatcher) {
    ...
    @Test
    fun nonBlankConversationId_emitsLoadedWithRepliesExcludingRoot() =
        runTest(dispatcher) {
    ...
    @Test
    fun newReplyAddedToConversation_updatesUiStateViaFlatMapLatest() =
        runTest(dispatcher) {
