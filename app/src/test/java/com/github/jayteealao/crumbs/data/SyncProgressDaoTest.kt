...
class SyncProgressDaoTest {
    ...
    @Test
    fun upsertThenGet_roundTripsAllColumns_includingWatermark() =
        runTest {
            val progress =
                SyncProgress(
                    uid = "uid-1",
    ...
    @Test
    fun watermark_roundTripsNull_forFreshInstall() =
        runTest {
            val fresh =
                SyncProgress(
                    uid = "uid-fresh",
    ...
    @Test
    fun upsert_replacesOnConflict_advancingWatermarkAndLowCursor() =
        runTest {
            val uid = "uid-2"
            dao.upsert(
    ...
    @Test
    fun get_returnsNull_forUnknownUid() =
        runTest {
